...
def create_app() -> FastAPI:
    ...
    # Register routers
    from app.routers import option_trades, portfolios, counterparties, calculations, imports, dashboard, curves, spot_trades, swap_trades, exchange_rates, scenarios
    ...
    app.include_router(swap_trades.router)
    app.include_router(swap_trades.import_router)
